document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".w-navigation-list");
  const headerRef = document.querySelector(".w-header");
  const navigationRef = document.querySelector(".w-navigation");
